<template>
    <div class="w-full lg:h-full">
        <h2 class="pt-8 lg:pt-0 z-0 font-bold text-5xl md:text-6xl ml-5 mr-5 lg:ml-16 lg:mr-16"> Testez vos connaissance: LGBTQIA+ </h2>

        <p class="text-2xl md:text-3xl mt-10 ml-5 mr-5 lg:ml-16 lg:mr-16">
            Réaliser un quiz sur à propos des LGBTQIA+.
        </p>

        <div class="m-auto flex mt-10 ml-5 mr-5 lg:ml-16 lg:mr-16">
            <router-link to="/articles/lgb">
...
<script setup lang="ts">
    ...
    const questions = ref([
        {
            type: "multi",
            question: "Est-ce que le sexfriend peut être intéressant ?",
            answer: [
                "Non c’est débile",
                "Cela dépend des envies sexuelles de chacun",
                "ça n’existe pas en réalité",
                "Pour les garçons seulement",
            ],
            correct: 2,
            answerText: "Un.e sexfriend peut être une occasion de découvrir un autre mode de sexualité, si on en ressent l’envie et si tout est bien clairement posé entre les deux partis.",
        },

        {
            type: "multi",
            question: "C’est quoi faire son coming-out ?",
            answer: [
                "Sortir de sa chambre après une semaine",
                "être à l’intérieur et arriver à l’extérieur",
                "rendre public sa sexualité/son orientation",
                "c’est se rendre compte qu’on est queer",
            ],
            correct: 3,
            answerText: "Le comming out permet de se libérer sur sa personnalité face à ses parents/ amis et entourage.",
        },

        {
            type: "multi",
            question: "Comment sait-on si on est homosexuel ?",
            answer: [
                "En découvrant des émotions fortes qu’on ressent pour une personne du même sexe",
                "Par hasard",
                "Parce qu’on correspond aux caractéristiques des homosexuels",
                "En écoutant du Britney Spears",
            ],
            correct: 2,
            answerText: "",
        },
        ...
        {
            type: "multi",
            question: "Les questions LGBTQIA+ sont un effet de mode, ça n’existait pas avant.",
            answer: [
                "Vrai",
                "Faux",
                "Je ne sais pas",
            ...
            correct: 2,
            answerText: "Les persécutions subies par les personnes LGBT+ les poussaient à se cacher mais ils ont toujours existé.",
        },

        {
            type: "multi",
            question: "Il existe une infinité de ressentis de genre.",
            answer: [
                "Vrai",
                "Faux",
                "Je ne sais pas",
            ...
            correct: 1,
            answerText: "L’expérience du genre est propre à chaque individu.",
        },

        {
            type: "multi",
            question: "Les lesbiennes n’ont simplement pas rencontré le bon garçon.",
            answer: [
                "Vrai",
                "Faux",
                "Je ne sais pas",
            ...
            correct: 2,
            answerText: "Les lesbiennes sont aussi conscientes que n’importe qui de leur sexualité, cette phrase les invisibilise et les infantilise.",
        },
    ]);
